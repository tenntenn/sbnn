...
// Tests for readDiff, the body of readStdin: what it does with a stat it
// could not make, with a real pipe, and with more than it will read. They sit
// in their own file rather than in root_test.go so that other work on the cmd
