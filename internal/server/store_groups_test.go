...
// The groups a session file can hold that sbnn would never have made itself:
// these live apart from store_test.go so that the file the rest of the store
// tests share stays exactly as main has it.
